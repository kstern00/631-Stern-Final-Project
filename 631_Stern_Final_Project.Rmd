...
Let's look at the data for a few specific places. First place:
```{r, echo=FALSE}
...
```{r, echo=FALSE, fig.align='left'}
plot(place_150$Year, place_150$Time, main = "Scatter Plot of Times for 150th Place", xlab = "Year", ylab = "Time (min)")
